...
class TestExpansionServiceGetExpansions:
    ...
    def setup_method(self):
        ...
        self.all_games = [
            ...
            {'name': 'Catan: Cities & Knights', 'is_expansion': '1', 'parent_game': 'Catan'},
            {'name': 'Gloomhaven', 'is_expansion': '0'},
            {'name': 'Gloomhaven: Expansion', 'is_expansion': '1', 'parent_game': 'Gloomhaven'},
        ]
...
class TestExpansionServiceGetParentGame:
    ...
    def test_get_parent_game_not_found(self):
        """測試取得主遊戲 - 主遊戲不存在"""
        orphan_games = [
            {'name': 'Orphan Expansion', 'is_expansion': '1', 'parent_game': 'Nonexistent Game'}
        ]
