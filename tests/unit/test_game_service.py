...
from core.exceptions import GameAlreadyBorrowedException, GameNotFoundException
...
class TestGameServiceBorrowGame:
    ...
    def test_borrow_game_success(self):
        ...
        mock_ws.get_all_records.return_value = [
            {
                FIELD_NAME: "卡坦島",
                FIELD_STATUS: GAME_STATUS_AVAILABLE,
                FIELD_BORROWER: "",
                FIELD_BORROWER_ID: "",
                FIELD_MDATE: "",
                FIELD_HISTORY: "",
        ...
        mock_client.create_batch_update.return_value = {
            "range": "A1",
            "values": [["test"]],
        }
        mock_member_service = MagicMock()
    ...
    def test_borrow_game_already_borrowed(self):
        ...
        mock_ws.get_all_records.return_value = [
            {
                FIELD_NAME: "卡坦島",
                FIELD_STATUS: GAME_STATUS_BORROWED,
                FIELD_BORROWER: "李四",
                FIELD_BORROWER_ID: "A002",
            }
        ]
        mock_member_service = MagicMock()
...
class TestGameServiceBatchBorrow:
    ...
    def test_batch_borrow_games_success(self):
        ...
        mock_member_service = MagicMock()
        mock_member_service.find_member_by_id.return_value = {
            "id": "A001",
            "name": "張三",
        }
