...
// 將函數暴露到全域作用域，以便 HTML onclick 可以呼叫
window.viewBGGGameDetails = viewBGGGameDetails;
window.toggleRecommendations = toggleRecommendations;
window.loadBGGCategory = loadBGGCategory;
window.loadMoreGames = loadMoreGames;
window.closeBGGModal = closeBGGModal;
window.closeBGGSearchModal = closeBGGSearchModal;
window.searchBGGInModal = searchBGGInModal;
window.addBGGGameToCollection = addBGGGameToCollection;
window.closeAddGameModal = closeAddGameModal;
window.confirmAddGame = confirmAddGame;
window.unlinkGameFromBGG = unlinkGameFromBGG;
